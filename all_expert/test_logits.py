...
from my_package.get_logits_feature import get_logits_featurev2
import os
import csv

models_dir = "/home/chengfangchi/graduate2302/code/cfc/最后的冯如杯/mult_transmil/record/对比实验/s4_transmil_logits_linear"
device = wait_gpu(0, 2000)
...
for model_name in os.listdir(models_dir):
    ...
    test_set = WSIFeaturesDataset("test", scales, feature_names, return_logits=True) # type: ignore
    ...
    for features, logits, text, main_label, sub_label in test_loader:
        ...
        with torch.no_grad():
            logits = model(logits_feature.to(device)).to("cpu")
